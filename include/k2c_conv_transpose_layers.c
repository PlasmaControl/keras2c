...
/**
 * 1D (temporal) Convolution Transpose
 ...
 * :param start_crop: number of elements to crop from the start of the output.
                      If padding is 'valid', this should be zero, for 'same' it
                      should be (kernel_size - stride) // 2.
